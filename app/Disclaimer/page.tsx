        ...
        <div className="bg-white p-8 md:p-12 rounded-2xl border border-slate-100 shadow-sm space-y-8 text-slate-600 leading-relaxed">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 text-sm text-blue-600 font-medium">
              <span className="bg-blue-50 px-3 py-1 rounded-full border border-blue-100">General Disclaimer</span>
              <span className="bg-blue-50 px-3 py-1 rounded-full border border-blue-100">Trademark Notice</span>
              <span className="bg-blue-50 px-3 py-1 rounded-full border border-blue-100">No Affiliation</span>
              <span className="bg-blue-50 px-3 py-1 rounded-full border border-blue-100">Service Accuracy</span>
              <span className="bg-blue-50 px-3 py-1 rounded-full border border-blue-100">Remote Consent</span>
              <span className="bg-blue-50 px-3 py-1 rounded-full border border-blue-100">Responsibility</span>
            </div>
          </div>
