      ...
      <section className="bg-white border-b border-slate-100 py-10 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center text-sm text-slate-600 gap-2">
            ...
            <span>&gt;</span>
            <span className="text-blue-600 font-semibold">Refund & Return Policy</span>
          </div>
        </div>
      </section>
        ...
        <div className="bg-white p-8 md:p-12 rounded-2xl border border-slate-100 shadow-sm space-y-8 text-slate-600 leading-relaxed">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 text-sm text-blue-600 font-medium">
              <span className="bg-blue-50 px-3 py-1 rounded-full border border-blue-100">Order Cancellation</span>
              <span className="bg-blue-50 px-3 py-1 rounded-full border border-blue-100">Return & Replacement</span>
              <span className="bg-blue-50 px-3 py-1 rounded-full border border-blue-100">Eligibility Criteria</span>
              <span className="bg-blue-50 px-3 py-1 rounded-full border border-blue-100">Non-Returnable Items</span>
              <span className="bg-blue-50 px-3 py-1 rounded-full border border-blue-100">Refund Timeline</span>
              <span className="bg-blue-50 px-3 py-1 rounded-full border border-blue-100">Shipping & Disputes</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mb-6">
              <a 
                href="#return-request" 
                className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-xl transition-colors shadow-sm"
              >
            ...
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 text-slate-700">
              ...
              <ul className="list-disc pl-5 text-sm mt-1">
                <li><a href="mailto:billing@geekonlinellc.com" className="text-blue-600 underline">billing@geekonlinellc.com</a></li>
              </ul>
            </div>
          </div>
