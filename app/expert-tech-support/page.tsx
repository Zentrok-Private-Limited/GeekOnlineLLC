  ...
  return (
    <main className="bg-slate-50 min-h-screen">
      ...
      <section className="bg-blue-50 py-16 text-center">
        <h1 className="text-4xl font-bold text-blue-600">Expert Tech Support</h1>
        <div className="flex justify-center items-center gap-2 mt-2 text-slate-600">
          <span className='text-blue-600'>Home</span> <FaChevronRight size={12} /> <span>Expert Tech Support</span>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto py-20 px-6">
        ...
        <div className="space-y-6 text-slate-600 leading-relaxed">
          <p>In today’s fast-paced digital landscape, uninterrupted technology is not just a convenience—it’s the backbone of productivity and business success. At <strong>Geek Online LLC</strong>, we go beyond just fixing problems; we proactively safeguard your systems, ensuring seamless operations at all times.Our expert, 24/7 tech support services are designed to provide businesses of all sizes with the reliability and efficiency needed to stay ahead in an evolving digital world.</p>
          ...
          <p>With Geek Online LLC, you’re not just getting a service—you’re gaining a trusted tech partner committed to delivering excellence in IT support, security, and business continuity.</p>
        </div>
      </section>
