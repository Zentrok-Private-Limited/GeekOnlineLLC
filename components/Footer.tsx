...
function Footer() {
  return (
    <div>
      {/* ================= FOOTER ================= */}
      <footer className="bg-blue-800 text-white border-t border-blue-100 pt-16 pb-8 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          <div className="col-span-2 md:col-span-1 space-y-4">
            <h3 className="font-black text-lg text-slate-50 border-b-2 border-blue-600 inline-block pb-1">
              Our Services
            </h3>
          ...
          <div className="col-span-2 md:col-span-1 space-y-4">
            ...
            <ul className="space-y-2 text-xs font-medium text-slate-100">
              <li>
                <a href="/Disclaimer" className="hover:text-blue-300 transition">
                  Disclaimer
                </a>
              </li>
              <li>
